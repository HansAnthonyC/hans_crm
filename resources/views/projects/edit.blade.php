                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('projects.update', $project) }}" id="projectForm">
                        ...
                        <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                            <p class="text-sm text-gray-500 mb-1">Lead</p>
                            <p class="font-semibold text-gray-900">{{ $project->lead->company_name }}</p>
                            <p class="text-sm text-gray-600">{{ $project->lead->contact_person }}</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-3" id="product-list">
                                ...
                                @php
                                    $isSelected = $project->products->contains($product->id);
                                    $pivot = $isSelected ? $project->products->find($product->id)->pivot : null;
                                    ...
                                    <label for="product_check_{{ $product->id }}" class="ml-4 flex-1 cursor-pointer">
                                        <div class="flex justify-between items-start">
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">{{ $product->code }} • {{ $product->speed ?? 'N/A' }}</p>
                                            </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('projects.show', $project) }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300">Batal</a>
